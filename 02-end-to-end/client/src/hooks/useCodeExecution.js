...
sys.stderr = _stdout_capture
      ...
      // Install numpy and pandas automatically
      setLoadingMessage('Installing numpy and pandas...');
      try {
        await pyodide.loadPackage('micropip');
        const micropip = pyodide.pyimport('micropip');
        await micropip.install(['numpy', 'pandas']);
        console.log('[Pyodide] Successfully installed numpy and pandas');
      } catch (installErr) {
        console.warn('[Pyodide] Failed to install numpy/pandas:', installErr);
        // Continue anyway - user can still use Python without these packages
        // The error will be shown if they try to import them
      }
