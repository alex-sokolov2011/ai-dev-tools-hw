      ...
      <main className="home__content">
        ...
        <div className="home__brand animate-fade-in">
          ...
          <h1 className="home__title">
            <span className="gradient-text">LiveCodeInterview</span>
          </h1>
        </div>
        ...
        {/* Feature Cards */}
        <div className="home__feature-cards animate-fade-in" style={{ animationDelay: '0.5s' }}>
          <div className="home__feature-card">
            <div className="home__feature-card-icon">👥</div>
            <h3 className="home__feature-card-title">Real-time Collaboration</h3>
            <p className="home__feature-card-text">
              Share code sessions with unique links. All participants see changes instantly.
            </p>
          </div>

          <div className="home__feature-card">
            <div className="home__feature-card-icon">
              <span className="home__feature-card-icon-python">🐍</span>
              <span className="home__feature-card-icon-js">{'{ }'}</span>
            </div>
            <h3 className="home__feature-card-title">Python & JavaScript Support</h3>
            <p className="home__feature-card-text">
              Write and execute Python (with NumPy/Pandas) and JavaScript directly in your browser.
            </p>
          </div>

          <div className="home__feature-card">
            <div className="home__feature-card-icon">▶️</div>
            <h3 className="home__feature-card-title">Browser-Based Execution</h3>
            <p className="home__feature-card-text">
              Code runs securely in your browser using WebAssembly. No server execution needed.
            </p>
          </div>

          <div className="home__feature-card">
            <div className="home__feature-card-icon">📟</div>
            <h3 className="home__feature-card-title">Shared Output Console</h3>
            <p className="home__feature-card-text">
              Execution results are synchronized across all connected users in real-time.
            </p>
          </div>
        </div>

        {/* Footer */}
        <footer className="home__footer animate-fade-in" style={{ animationDelay: '0.6s' }}>
