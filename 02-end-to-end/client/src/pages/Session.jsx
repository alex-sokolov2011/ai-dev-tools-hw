...
// Optional footer branding (set to true to enable)
const ENABLE_FOOTER_BRANDING = false;
  ...
  return (
    <div className="session">
      ...
      <main className="session__main">
        ...
        {ENABLE_FOOTER_BRANDING && (
          <footer className="session__footer">
            <p>
              Built by <strong>Aleksandr Sokolov</strong> for AI Dev Tools Zoomcamp
              {' · '}
              <a
                href="https://github.com/alex-sokolov2011"
                target="_blank"
                rel="noopener noreferrer"
                className="session__footer-link"
              >
                GitHub
              </a>
            </p>
